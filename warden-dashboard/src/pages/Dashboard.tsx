      ...
      <main className="p-margin-desktop min-h-screen max-w-[1440px] mx-auto w-full">
        <div className="flex flex-col gap-gutter">
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
            {/* Total Movements */}
            <div className="glass-card rounded-3xl p-stack-md border-l-4 border-primary">
              <div className="flex items-center justify-between mb-unit">
                ...
                <Activity size={20} className="text-primary glow-orange" />
              </div>
            ...
            {/* Currently Inside */}
            <div className="glass-card rounded-3xl p-stack-md border-l-4 border-secondary">
              <div className="flex items-center justify-between mb-unit">
                <p className="text-label-md font-label-md text-on-surface-variant">CURRENTLY INSIDE</p>
                <Users size={20} className="text-secondary glow-orange" />
              </div>
              <div className="flex items-end justify-between">
            ...
            {/* System Status */}
            <div className="glass-card rounded-3xl p-stack-md border-l-4 border-tertiary">
              <div className="flex items-center justify-between mb-unit">
                <p className="text-label-md font-label-md text-on-surface-variant">SYSTEM STATUS</p>
                <Radio size={20} className="text-tertiary glow-orange" />
              </div>
              <div className="flex items-center gap-3 mt-2">
                <div className={`w-4 h-4 rounded-full ${socketConnected ? 'bg-secondary animate-pulse glow-orange-lg' : 'bg-error'}`}></div>
          ...
          {/* Table / Feed Area */}
          <section className="glass-card rounded-3xl p-stack-lg">
            <div className="flex items-center justify-between mb-stack-lg">
              <h4 className="font-headline-md text-[24px] font-bold text-on-surface">Real-Time Movement Log</h4>
              <button className="glass-button px-stack-md py-2 rounded-xl text-label-md font-label-md text-primary uppercase tracking-widest hover:text-primary transition-colors">
                Export Data
              </button>
            </div>
